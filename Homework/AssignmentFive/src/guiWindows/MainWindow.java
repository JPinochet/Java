 ...
 *
 * version 1.0
 * App. that creates the main client window with tabs 
 * and allows switching between multiple tabs for the purpose of 
 * inputting client, commercial and residential window.
 */
public class MainWindow extends JFrame
{
	/**
	 * This generated constant is to have the same serial ID everytime you run the app and don't 
	 * have any problem if the program is changed some way.
	 */
	private static final long serialVersionUID = -4606890528133443422L;
