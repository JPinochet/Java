...
public class Word
{
	...
	/**
	 * Constructs a word by removing leading and trailing non-letter characters, such as punctuation marks.
	 ...
	 * leading and trailing nonletter characters.
	...
	public int countSyllables()
	{
		...
		//An e at the end of the word doens't count as a vowed.
		...
		boolean insideVolumeGroup = false;
		for(int i = 0; i <= end; i++)
		{
			...
			{
				//ch is a vowel
				if (!insideVolumeGroup)
				{
					//Starts of new vowel grop
					count++;
					insideVolumeGroup = true;
				}
			}
		}
