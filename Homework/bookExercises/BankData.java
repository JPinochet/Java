 ...
 * @author 432873
 * Pg.831
 * This class is a conduit to random access file containing
 * savings account data
 */
public class BankData
{
	/**
	 * Constructs a BankData that is not associated with a file
	 */
	public BankData()
	{
		file = null;
	...
	/**
	 * Opens the data file.
	 * @param filename the name of the file containing savings account information
	 */
	 ...
	 * 0r -1 if there is no such account
	 */
